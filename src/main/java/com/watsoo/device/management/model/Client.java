...
public class Client {
	...
	private List<ClientStateGstMapping> clientStateGstMapping;
	...
	public List<ClientStateGstMapping> getClientStateGstMapping() {
		return clientStateGstMapping;
	}

	public void setClientStateGstMapping(List<ClientStateGstMapping> clientStateGstMapping) {
		this.clientStateGstMapping = clientStateGstMapping;
	}
	...
	public Client(Long id, String companyId, String companyName, String companyAddress, State state, String city,
