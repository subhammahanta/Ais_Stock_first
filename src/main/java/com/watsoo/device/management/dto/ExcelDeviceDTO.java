...
public class ExcelDeviceDTO {
	...
	public ExcelDeviceDTO() {
		super();
	}

	public ExcelDeviceDTO(Long id, String imeiNo, String ccidNo, String uidNo, String sim1Number, String sim2Number,
			Date sim1ActivationDate, Date sim2ActivationDate, Date deviceIssueDate, Date deviceActivatedDate,
			String clientName, String state) {
		super();
		this.id = id;
		this.imeiNo = imeiNo;
		this.ccidNo = ccidNo;
	...
	public ExcelDeviceDTO(Long id, String imeiNo, String ccidNo, String uidNo, String sim1Number, String sim2Number,
			Date sim1ActivationDate, Date sim2ActivationDate, Date deviceIssueDate, Date deviceActivatedDate,
			String clientName, String state, Date sim1ExpireDate, Date sim2ExpireDate, String sim1Operator,
			String sim2Operator) {
		super();
		this.id = id;
		this.imeiNo = imeiNo;
